 ...
 * @return
 */
void displayLeds(uint32_t data, uint digitos, gpioConf_t *vectorGpio, gpioConf_t *vectorGPIO_map, uint8_t *bcd_number)
{
	convertToBcdArray(data, digitos, bcd_number);
	for (int i = 0; i < digitos; i++)
	{
		BCDtoGPIO(vectorGpio, bcd_number[i]);
...
void app_main(void)
{
	...
	BCDtoGPIO(vectorGPIOs, 56);
	displayLeds(numero, digitos, vectorGPIOs, vectorGPIO_mapeo, bcd_number);
}
/*==================[end of file]============================================*/
